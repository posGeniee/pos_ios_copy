...
class PluGroupProductScreen extends StatefulWidget {
  static const routeName = '/PluGroupProductScreen';
  const PluGroupProductScreen({
    Key? key,
  }) : super(key: key);

  @override
  _PluGroupProductScreenState createState() => _PluGroupProductScreenState();
}

class _PluGroupProductScreenState extends State<PluGroupProductScreen> {
  ...
  mockFetch() async {
    ...
    final responseString =
        await ItemSearchApiFuncion().pluGroupById(pageNo, args.title, token);
...
//   const PluGroupProductScreen({Key? key, required this.searchString})
//       : super(key: key);
