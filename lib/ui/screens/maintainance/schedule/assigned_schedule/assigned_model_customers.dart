...
class ModelSheetofCustomers extends StatefulWidget {
  const ModelSheetofCustomers({
    Key? key,
  }) : super(key: key);

  @override
  State<ModelSheetofCustomers> createState() => _ModelSheetofCustomersState();
}

class _ModelSheetofCustomersState extends State<ModelSheetofCustomers> {
  ...
  mockFetch() async {
    ...
    final responseString = await MaintainanceApiFunction()
        .getCustomers(locationId.toString(), token, pageNo);

    final newList = customerListModelFromMap(responseString).data!.data;
                          ...
                          itemBuilder: (context, index) {
                            if (index < items!.length) {
                              return ListTile(
                                ...
                                onTap: () {
                                  if (!mounted) return; setState(() {
                                    categoryName.text = items![index].fullName;
                                  });
