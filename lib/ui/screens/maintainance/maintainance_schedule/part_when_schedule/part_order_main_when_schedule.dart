...
class PartsOrderMainScreenWhenSchedule extends StatefulWidget {
  static const routeName = '/PartsOrderMainScreenWhenSchedule';
  ...
  @override
  _PartsOrderMainScreenWhenScheduleState createState() =>
      _PartsOrderMainScreenWhenScheduleState();
}

class _PartsOrderMainScreenWhenScheduleState
    extends State<PartsOrderMainScreenWhenSchedule>
    with AutomaticKeepAliveClientMixin<PartsOrderMainScreenWhenSchedule> {
  @override
  ...
  mockFetch() async {
    ...
    final responseString =
        await MaintainanceApiFunction().getPartsOrderWhenSchedule(
      locationId.toString(),
      token,
      pageNo,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        heroTag: PartsOrderMainScreenWhenSchedule.routeName,
        elevation: 0.0,
        child: const Icon(
          CupertinoIcons.add,
          color: Colors.white,
        ...
        onPressed: () {
          ...
          Navigator.of(context).pushNamed(
            AddPartOrderWhenSchedule.routeName,
            arguments: args,
          );
        },
      ),
                        ...
                        return ListTile(
                          ...
                          onTap: () {
                            final args = ModalRoute.of(context)!
                                .settings
                                .arguments as ScheduleModelDatum;
                            Navigator.of(context).pushNamed(
                              UpdatePartOrderWhenSchedule.routeName,
                              arguments:
                                  DoubleScreenArguments(args, items[index]),
                            );
                            // if (index == 1) {
                            //   Navigator.of(context).pushNamed(
                            //     UpdatePartOrderWhenSchedule.routeName,
