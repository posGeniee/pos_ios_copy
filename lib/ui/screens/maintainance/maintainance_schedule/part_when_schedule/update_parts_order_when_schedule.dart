...
class _UpdatePartOrderWhenScheduleState
  ...
  initilizeData() async {
    ...
    final args2 = args.reportFullPath as PartOrderDatum;
    nameField.text = "";
    dateField.text = formatofDateForViewwithTime.format(args2.recieveDate);

    linkField.text = args2.link;
    descriptionField.text = args2.description;
    supplierField.text = args2.supplierName;
    categoryField.text = args2.partCateName;
    partCategoryDatum = PartCategoryDatum(
        id: int.parse(args2.partCateId),
        businessId: 0,
        locationId: "0",
        name: '',
        profit: '0',
