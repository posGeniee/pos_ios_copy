...
class PartsCategoryMainScreen extends StatefulWidget {
  static const routeName = '/PartsCategoryMainScreen';
  const PartsCategoryMainScreen({Key? key}) : super(key: key);

  @override
  _PartsCategoryMainScreenState createState() =>
      _PartsCategoryMainScreenState();
}

class _PartsCategoryMainScreenState extends State<PartsCategoryMainScreen>
    with AutomaticKeepAliveClientMixin<PartsCategoryMainScreen> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        heroTag: PartsCategoryMainScreen.routeName,
        elevation: 0.0,
        child: const Icon(
          CupertinoIcons.add,
          color: Colors.white,
        ...
        onPressed: () {
          Navigator.of(context).pushNamed(
            AddPartCategoryScreen.routeName,
          );
        },
      ),
      body: LayoutBuilder(
                              ...
                              RichText(
                                text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    ...
                                    TextSpan(text: items[index].profit),
                                  ],
                                ),
                              ),
                            ],
